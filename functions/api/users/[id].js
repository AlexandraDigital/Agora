...
export async function onRequestPut({ request, params, env }) {
  try {
    ...
    // when you save an uploaded photo (to clear the old emoji), and
    // avatarImage isn't sent as null but SHOULD stay untouched on a plain
    // displayName/bio edit. hasOwnProperty tells those apart; ?? doesn't.
