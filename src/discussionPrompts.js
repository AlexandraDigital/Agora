...
// generator. Used only when there are no comments to tailor to yet, or the
// AI call is unavailable/fails; the client's own generateDiscussionPrompt
// already covers the same theme-detected case on initial mount, so the two
// never need to agree exactly — this just has to be a reasonable question.
